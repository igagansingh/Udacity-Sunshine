 ...
 */
package com.gagandeep.developer.sunshine.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public long testLocationTable() {
        ...
        ContentValues c = TestUtilities.createNorthPoleLocationValues();
        // Insert ContentValues into database and get a row ID back
        long rowID = db.insert(WeatherContract.LocationEntry.TABLE_NAME,null,c);
            assertTrue(rowID != -1);
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("ERROR RO BHAIO",cursor,c);
        assertFalse("ERROR: MORE THAN ONE ROW FOUND IN LOCATION TABLE", cursor.moveToNext());
